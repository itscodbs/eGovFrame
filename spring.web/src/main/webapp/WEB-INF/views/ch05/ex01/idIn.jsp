...
<script src="https://ajax.googelapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
		...
		$.ajax({
			...
			success:function(result){
				if(result.duplicated === true)
					$("#msgModal #msg").text("이미 등록된 아이디 : " + result.avaliableId + "를 권합니다.")
