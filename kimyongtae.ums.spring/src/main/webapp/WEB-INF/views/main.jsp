			...
			success : function(users){
				$(users).each(function(idx, user){
					...
					td = $("<td><input type='radio' name='userNo' value=''"
							+ user.usreNo + "onClick='showUser(this)'/>"
							+ "&nbsp;&nbsp;&nbsp;"
							+ user.userNo + "</td>");
					td2 = $("<td>" + user.usreName + "onClick='showUser(this)'/>"
							+ "&nbsp;&nbsp;&nbsp;"
							+ user.userNo + "</td>");
				...
				<div class="btn-group btn-group-justified">
					<div class="btn-group">
						<button type="button" class="btn btn-default" id="listBtn">
							<span class="glyphicon glyphicon glyphicon-list"></span> list
						</button>
					</div>
					...
					<div class="btn-group">
						<button type="button" class="btn btn-default" id="updateBtn">
							<span class="glyphicon glyphicon glyphicon-asterisk"></span> update
						</button>
					</div>
