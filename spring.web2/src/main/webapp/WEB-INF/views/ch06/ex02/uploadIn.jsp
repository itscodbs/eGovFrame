...
<link rel="stylesheer" href="http://maxcdn.bootstrap.com/bootstrap/3.3.6/css/bootstrap.min.css">
<script src="https://ajax.googleapis/com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
<script src="http://maxcdn.bootstrap.com/bootstrap/3.3.6/css/bootstrap.min.css"></script>
<script>
// 버튼별 handler를 등록한다.
var regButtons = function(){
	$(":button#send").bind("click", function(){
		var formData = new FormDate($("form")[0]);
		$.ajax({
			method : "post",
			data : formData,
